    ...
    return (
        <div id="scroll-override" className="w-full h-full max-h-full overflow-y-auto snap-y snap-mandatory overflow-x-clip">
            <div className="container mx-auto p-4 gap-4 sm:gap-8 sm:items-center h-full">
                <AnimatedContainer className="flex flex-col xl:flex-row items-center w-full h-full snap-center snap-always my-8">
                    <Image src={devshLogo} alt="Nabla Logo" className="aspect-square w-[480px]"/> 
                    <TextBlock>
                ...
                <AnimatedContainer className="flex flex-row items-center justify-between w-full h-full snap-center snap-always gap-12 max-w-full">
                    <div className="grow min-w-fit flex flex-col gap-8 justify-center">
                        <h1>Features</h1>
                        <ul className="grow flex flex-col list-none gap-2 text-xl list-image-[url(/list/check.svg)] list-inside">
                    ...
                    <Image
                        ...
                        alt="Showcase Image"
                        className="shrink object-cover object-center"
                    />
                </AnimatedContainer>
            </div>
        </div>
